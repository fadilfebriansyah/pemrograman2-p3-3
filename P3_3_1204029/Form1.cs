...
namespace P3_3_1204029
{
    public partial class Form1 : Form
    {
        ...
        private void tsbMouse_Click(object sender, EventArgs e)
        {
            ...
            {
                tslKetGambar.Text = "Cocock! Ini adalah gambar mouse";
            }
            else
            {
        ...
        private void tsbMonitor_Click(object sender, EventArgs e)
        {
            ...
            {
                tslKetGambar.Text = "Cocock! Ini adalah gambar monitor";
            }
            else
            {
        ...
        private void tsbPrinter_Click(object sender, EventArgs e)
        {
            ...
            {
                tslKetGambar.Text = "Cocock! Ini adalah gambar printer";
            }
            else
            {
        ...
        private void tsbKeyboard_Click(object sender, EventArgs e)
        {
            ...
            {
                tslKetGambar.Text = "Cocock! Ini adalah gambar keyboard";
            }
            else
            {
        ...
        private void tsbScanner_Click(object sender, EventArgs e)
        {
            ...
            {
                tslKetGambar.Text = "Cocock! Ini adalah gambar scanner";
            }
            else
            {
